...
$address = "robert.schleinhege@outlook.de";
...
$e_body = "Bestellung von $first_name. $first_name möchte $no_of_personas. Kiste: $preferred_food. Mail ist $email " . PHP_EOL . PHP_EOL;
